package Baseliner::Schema::Harvest::Result::Harremitemproc;
...
__PACKAGE__->table("harremitemproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:bcVa08sTVBU+aWc9xJ8oKA
