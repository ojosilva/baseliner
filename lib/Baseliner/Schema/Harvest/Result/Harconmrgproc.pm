package Baseliner::Schema::Harvest::Result::Harconmrgproc;
...
__PACKAGE__->table("harconmrgproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:1KhS/gXPisRLciG49cEq1g
