package Baseliner::Schema::Harvest::Result::Harlistdiffproc;
...
__PACKAGE__->table("harlistdiffproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:d54Ee6bdGTWsZTWIa1OQRA
