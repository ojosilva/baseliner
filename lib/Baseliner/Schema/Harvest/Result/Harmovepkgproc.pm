package Baseliner::Schema::Harvest::Result::Harmovepkgproc;
...
__PACKAGE__->table("harmovepkgproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Qf5+zxtHnwkAOyjZ+XJ1Xw
