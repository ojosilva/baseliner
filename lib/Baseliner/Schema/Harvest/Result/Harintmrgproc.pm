package Baseliner::Schema::Harvest::Result::Harintmrgproc;
...
__PACKAGE__->table("harintmrgproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WwEoL+QG3D8TNoTXoLmghg
