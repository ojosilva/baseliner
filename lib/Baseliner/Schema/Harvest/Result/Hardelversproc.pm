package Baseliner::Schema::Harvest::Result::Hardelversproc;
...
__PACKAGE__->table("hardelversproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Zz7+w3+1n2PoKdBqKignCA
