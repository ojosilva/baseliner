package Baseliner::Schema::Harvest::Result::Harrenameitemproc;
...
__PACKAGE__->table("harrenameitemproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FxI3ECk7RxIfHLuCS2yvbw
