package Baseliner::Schema::Harvest::Result::Harsnapviewproc;
...
__PACKAGE__->table("harsnapviewproc");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:dmNDD8tTtPSJx66SrO8MQA
